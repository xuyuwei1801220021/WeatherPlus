package com.xuyuwei.app.com.xuyuwei.app.bean;
...
public class TodayWeather {
    ...
    private String type;
    private String week_today,temperatureH,temperatureL,climate,wind,week_today1,temperatureH1
            ,temperatureL1,climate1,wind1,week_today2,temperatureH2,temperatureL2,climate2,wind2;
    private String week_today3,temperatureH3,temperatureL3,climate3,wind3,week_today4,temperatureH4,
    ...
    public String toString(){
        return "TodayWeather{" +
                ...
                ",wind5='"+wind5+ '\'' +
                "}";
//week_today,temperatureH,temperatureL,climate,wind
    }
}